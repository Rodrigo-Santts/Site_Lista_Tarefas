			...
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						...
						<li class="list-group-item active"><a href="#">Tarefas finalizadas</a></li>
					</ul>
				</div>
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<hr />
                        <?php foreach($tarefas as $key => $test ) { ?> 
                           <div class="row mb-3 d-flex align-items-center tarefa">
                              <div class="col-sm-9"><?= $test->tarefa?>
                              ...
                              <div class="col-sm-3 mt-2 d-flex justify-content-end">
                                 ...
                                 <i class="fas fa-edit fa-lg text-info ml-3"></i>
                              </div>
                           </div>
                           <hr>
                        <?}?>   
